#!/usr/bin/env python3
"""
Freeciv Agent — LLM-powered autonomous Freeciv player (single agent).
...
async def read_stdin(agent: FreecivAgent):
...
async def main():
    parser = argparse.ArgumentParser(description="Freeciv Agent (single)")
    ...
    try:
        ...
        agent = FreecivAgent(client, name=username)
